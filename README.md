...
<ol>
  ...
  <li>If you are met with the error "<em>'pip3' is not recognized as an internal or external command, operable program or batch file.</em>", it means pip wasn't installed with Anaconda. Type "conda -c install anaconda pip" to fix this, then try the previous step again. </li>
